...
from nebulatimesedge.common.http.pre_conn import PreConnAdapter
...
logger = logging.getLogger("bjynebulatimesedge_sdk_common")
...
class ApiRequest(object):
    ...
    def _request(self, req_inter):
        ...
        if req_inter.method == 'GET':
            ...
            raise NebulatimesEdgeSDKException(
    ...
    def send_request(self, req_inter):
        try:
            ...
            raise NebulatimesEdgeSDKException("ClientNetworkError", str(e))
