...
class CommonClient(AbstractClient):
    """
    使用CommonClient，可以只安装nebulatimesedge-sdk-python-common包，即可调用各个产品的接口
    使用详情见github示例
    ...
    def __init__(self, service, version, credential, region, profile=None):
        ...
        :type credential: nebulatimesedge.common.credential.Credential or nebulatimesedge.common.credential.STSAssumeRoleCredential or None
        :param region: 接口调用地域
        :type region: str
        :param version: 接口版本
        :type version: str
        ...
        :type profile: nebulatimesedge.common.profile.client_profile.ClientProfile
        """
        if region is None or version is None or service is None:
            raise NebulatimesEdgeSDKException("CommonClient Parameter Error, "
